...
{
    string[] autoTestPasswords = { "Radwa4869", "radwaahmed4869@gmail.com", "01120273611",
                                   "RadwA4869?", "radwaahmed4869", "20273611",
                                   "pAssw0rd", "12345678", "abcdefghi",
    ...
    string fileLocation = "\\__Test\\Radwa\\zxcvbn";
    //string fileLocation = "C:\\Users\\Radwa\\Desktop\\Graduation\\Network-Ninja-GitVersion\\Network Ninja\\Assets\\__Test\\Radwa\\zxcvbn";
    string fileName = "PasswordResults_2.txt";

    IEnumerable<string> userData = new string[] { "Radwa4869", "radwaahmed4869@gmail.com", "01120273611" };

    void Start()
    {
        // delete file if exist
        File.Delete(Path.Combine(Application.dataPath + fileLocation, fileName));
    ...
    {
        Result result = Zxcvbn.Core.EvaluatePassword(testPassword, userData);
    ...
    public void WriteToFile(string fileName, string text)
    {
        ...
        string filePath = Path.Combine(Application.dataPath + fileLocation, fileName);
